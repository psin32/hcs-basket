...
@Component
public class BasketJWTAuthorizationFilter extends BasicAuthenticationFilter {

	private BasketSecurityConfiguration securityConfiguration;

	public BasketJWTAuthorizationFilter(AuthenticationManager authManager) {
		super(authManager);
	}
	...
	protected void doFilterInternal(HttpServletRequest req, HttpServletResponse res, FilterChain chain)
		...
		if (securityConfiguration == null) {
			...
			securityConfiguration = webApplicationContext.getBean(BasketSecurityConfiguration.class);
		}
